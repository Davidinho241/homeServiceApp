...
@property (nonatomic, readonly, copy) NSArray<id <UIPreviewActionItem>> * _Nonnull previewActionItems SWIFT_AVAILABILITY(ios,introduced=9.0);
...
@interface DKPhotoImageView : FLAnimatedImageView
