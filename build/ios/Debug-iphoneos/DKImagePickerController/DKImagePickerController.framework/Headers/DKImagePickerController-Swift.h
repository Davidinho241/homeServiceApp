...
- (void)fetchImageDataWithOptions:(PHImageRequestOptions * _Nullable)options completeBlock:(void (^ _Nonnull)(NSData * _Nullable, NSDictionary * _Nullable))completeBlock;
...
- (void)saveImageDataToAlbumForiOS8:(NSData * _Nonnull)imageData :(NSDictionary * _Nullable)metadata :(void (^ _Nonnull)(DKAsset * _Nonnull))completeBlock;
